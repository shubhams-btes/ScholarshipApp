...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                "admin_panel.context_processors.site_name",
            ],
        },
    },
]
...
CSRF_TRUSTED_ORIGINS = [
    ...
    'https://182.76.176.205:5142',
    'http://talentquest.btes.co.in',  # If you plan to use HTTPS
]
...
EMAIL_HOST = "mail.btes.co.in"         # Outgoing SMTP server
EMAIL_PORT = 465                        # SSL port
EMAIL_USE_SSL = True                     # Use SSL for port 465
EMAIL_USE_TLS = False                    # TLS only for port 587
